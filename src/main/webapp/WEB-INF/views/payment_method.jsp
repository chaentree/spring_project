...
<div>
		<table class="left" style="width:200px; font-size:16px;">
			...
			<tr>
				<td style="cursor:pointer;" onclick="location.href='privacy.do.do?userid=${vo.userid}'"><br><img src="resources/nike/person_scret.png" style="width: 30px; height: auto; display:inline;" >
				&nbsp;&nbsp;&nbsp;&nbsp;개인 정보관리</td>
			</tr>
			<tr>
		...
		<div class="main">
			<div style="marign:0px 0px 36px; width:588.98px; height: 28px;">
				<h2 style="font-weight:500; font-size:24px; line-height:28px;">결제 수단 저장</h2>
			</div>
			<div>
			<br><br>현재 저장된 결제 수단이 없습니다. 더 빠른 주문 결제를 위해 결제수단을 미리<br> 입력해 두세요.
			</div>
			<div style="left:50%">
			<br><br><input type="button" value="결제 수단 추가" onclick="location.href='sorry.do'">
			</div>

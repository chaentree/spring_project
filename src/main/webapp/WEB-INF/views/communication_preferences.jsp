...
<div>
		...
		<div class="main">
			<div style="marign:0px 0px 36px; width:588.98px; height: 28px;">
				<h2 style="font-weight:500; font-size:24px; line-height:28px;">마케팅 수신 동의 설정</h2>
			</div>
			<div>
			<br><br>마케팅 정보 수신<br><br>
			상품, 할인 정보, 멤버 혜택 관련 최신 소식을 받아보세요.
			<br><br>
			<input type="checkbox" style="width:24px; height:24px; position:absolute;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			문자메시지 수신 동의
			</div>
			<div style="left:50%">

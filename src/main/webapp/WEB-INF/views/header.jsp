...
<body>
	...
	<header id="header" class="header">
			...
			<div class="nav">
				<ul class="menu">
					...
					<li class="menu-li center"><a href="#">고객센터</a> <!-- 마우스 호버시 나타나는 부분 -->
						<ul class="menu-sub">
							...
							<li class="sub-menu-li"><a
								href="myorder.do?userid=${vo.userid}">주문</a></li>
					...
					<c:if test="${i ne null}">
						<span> | </span>
						<!-- 로그인시 보이는 상단바 수정 -->
						<li class="menu-li member"><a
							href="profile.do?userid=${vo.userid }">${vo.last_name}${vo.first_name}님,
								환영합니다.&nbsp;&nbsp;&nbsp; <img
								src="resources/nike/person_main.png"
								style="width: 20px; display: inline; position: absolute;">
						</a> <!-- 마우스 호버시 나타나는 부분 -->
							<ul class="menu-sub_mem">
								...
								<li class="sub-menu-li"><a
									href="member_modi_form.do?userid=${vo.userid}">회원정보관리</a></li>
		...
		<div class="header_2nd">
			...
			<div class="nike_logo">
				...
				<c:if test="${i ne null}">
					<a href="login.do?userid=${vo.userid}"><img
						src="resources/nike/ni-lo.png"> </a>
				</c:if>
			</div>
			<!-- category 메뉴 -->
			<div class="category">
			...
			<div class="btn">
				<ul class="category_btn">
					<!-- 검색 아이콘 -->
					<li class="search"><a href="#" id="search_icon"> <img
							src="resources/nike/search.svg"></a> <!-- 검색 입력 부분 --> <input
						id="search_area" class="search-box" type="text" placeholder="검색">
					</li>
							<!-- 위시리스트&카트 버튼 -->
					<c:if test="${i eq null}">  
	...
	<section class="section section0"
		style="background-color: #fff; box-shadow: inset 0 0px 0 0 #fff;">

...
<div>
		...
		<div class="main">
			<div style="marign:0px 0px 36px; width:588.98px; height: 28px;">
				<h2 style="font-weight:500; font-size:24px; line-height:28px;">개인 정보 관리</h2>
			</div>
			<div>
			<span style="font-weight:bold;"><br><br>Nike Run Club 및 Nike Training Club</span>
			<br><br>
			내 운동 데이터를 바탕으로 맞춤 트레이닝 플랜과 제품을 추천받고, 특별 이벤트에도<br>초대받습니다.
			<br><br>
			<input type="checkbox" name="use" style="width:24px; height:24px; position:absolute;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			운동 데이터 사용<br><br>
			
			</div>
			<div style="color:#757575;">
			개인 정보 보호 설정이 모든 나이키 앱에 적용됩니다. 하나의 앱에서 설정을 변경하면 모든 앱의 설정이<br>
			변경됩니다. 자세한 내용을 확인하려면 <a href="https://agreementservice.svs.nike.com/rest/agreement?agreementType=privacyPolicy&language=ko&requestType=redirect&uxId=com.nike.commerce.nikedotcom.web&country=kr" style="color:#757575;">개인 정보 취급 방침</a>
			페이지를 방문하세요.
			</div>

...
<div>
		...
		<div class="main">
			<div style="marign:0px 0px 36px; width:588.98px; height: 28px;">
				<h2 style="font-weight:500; font-size:24px; line-height:28px;">프로필 공개 설정</h2>
			</div>
			<div>
			<br><br>나이키 프로필은 제품 리뷰 및 나이키 관련 앱 전반에 노출됩니다.
			<br><br>
			<img src= "${pageContext.request.contextPath}/resources/nike/default_avatar.png" style="width:120px; hegith:120px; border-radius:8px; display:inline; position:absolute">
			<div style="left:20%;">
			프로필 표시<br>
			<span style="color:#757575;">${vo.last_name}${vo.first_name}<br><br></span>
			<input type="button" value="수정" onclick="location.href='member_modi_form.do?userid=${vo.userid}'" style="width:104.86px; height: 36px; background-color:#fff; color:#111;">
			</div>
			<br><br>
			<div>
			...
			<div>
			제품 리뷰 설정<br><br>
			작성한 리뷰에 프로필이 노출되는 방법을 선택하세요. 이 설정은 Nike Training Club 및<br>
			Nike Run Club 앱에서 친구와 연결할 때 영향을 줍니다. <a href="#" style="color:#111; font-weight:bold; margin: 0 0 0 3px;  text-decoration-line:underline;text-underline-position: under; ">자세히 보기</a>
			</div>
			<br><br><input type="radio" name="privacy-private" style="width:24px; height:24px; position:absolute;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			비공개 : 나만 볼 수 있는 프로필<br>
			<br><input type="radio" name="privacy-private" style="width:24px; height:24px; position:absolute;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			소셜 : 친구에게만 표시되는 프로필<br>
			<br><input type="radio" name="privacy-private" style="width:24px; height:24px; position:absolute;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			공개 : 누구나 프로필을 볼 수 있습니다.<br><br>
			
			위치 공유<br><br>
			<input type="radio" name="visibilityLocation" style="width:24px; height:24px; position:absolute;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			소셜 : 친구에게만 표시되는 프로필<br>
			<br><input type="radio" name="visibilityLocation" style="width:24px; height:24px; position:absolute;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			위치를 공유하지 않습니다<br>
			</div>
